/*
  # Fix new sale email: anexos apenas para email da operadora (CALL 3)

  ## Resumo
  Corrige a lógica de envio de emails para novas vendas:
  - CALL 1 (admins/BO ou operator_user_ids): sem anexos
  - CALL 2 (parceiro/vendedor): sem anexos
  - CALL 3 (notification_emails da operadora - endereços externos): COM anexos

  ## Motivação
  Emails com anexos grandes (>1MB) falham por limite de recursos na edge function
  quando enviados para múltiplos destinos. Ao reservar os anexos apenas para a
  operadora, garantimos entrega fiável sem sobrecarregar o sistema.
*/
