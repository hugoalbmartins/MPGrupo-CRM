/*
  # Update save_commission_configs RPC to support technology field

  1. Modified Functions
    - `save_commission_configs` - Added `technology` column to the INSERT statement
      so that commission configurations can be tagged with a specific technology
      (Fibra or SAT) when operators use individual SAT commissions

  2. Notes
    - technology is nullable; NULL or absent means Fibra (backward compatible)
    - Only telecom operators with sat_commission_mode='individual' will have
      commission configs with technology='SAT'
*/
