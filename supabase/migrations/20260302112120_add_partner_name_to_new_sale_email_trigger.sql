/*
  # Add partner_name to new sale email trigger

  ## Summary
  Updates the create_new_sale_alert_with_email function and trigger_new_sale_alert
  to pass the partner name to the send-new-sale-email edge function.

  ## Changes
  1. Drops and recreates create_new_sale_alert_with_email with new p_partner_name parameter
  2. Updates trigger_new_sale_alert to look up and pass partner name from the partners table
*/
...
-- Step 3: Recreate function with partner_name parameter
...
-- Step 4: Recreate trigger function to look up and pass partner name
