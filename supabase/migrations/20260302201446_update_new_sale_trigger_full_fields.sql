/*
  # Update new sale email trigger with full field set

  ## Summary
  Updates create_new_sale_alert_with_email and trigger_new_sale_alert to pass all sale fields
  to the send-new-sale-email edge function, enabling per-operator email field configuration.

  ## New fields passed
  - client_contact, client_email, client_iban
  - address (street + postal_code + locality combined), installation_address
  - energy_sale_type
...
-- Step 2: Drop old function (all known signatures)
...
-- Step 3: Recreate function with full field set
...
-- Step 4: Recreate trigger function with full field set
