/*
  # Update save_commission_configs RPC to include SMTP override fields

  1. Modified Functions
    - `save_commission_configs` - added from_email and from_smtp_pass fields
      to the INSERT statement within the loop

  2. Important Notes
    - from_email and from_smtp_pass are nullable text fields
    - When set, they override the global/operator SMTP settings for emails
      related to this commission configuration
*/
