...
const SectionHeader = ({ children }) => (
  <div className="col-span-2 pt-2 pb-1 border-t border-white/[0.06]">
    <h3 className="text-sm font-semibold text-dark-200 uppercase tracking-wide">{children}</h3>
  </div>
);
      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-hidden glass-ultra border-white/10 flex flex-col p-0">
        ...
        <form onSubmit={onSubmit} className="flex flex-col flex-1 overflow-hidden">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {/* Contact info */}
            <SectionHeader>Contactos</SectionHeader>
            ...
            {editFormData.scope === 'telecomunicacoes' && (
              <>
                <SectionHeader>Detalhes Telecomunicacoes</SectionHeader>
            ...
            {editFormData.scope === 'solar' && (
              <>
                <SectionHeader>Detalhes Solar</SectionHeader>
            ...
            {editFormData.scope === 'energia' && (
              <>
                <SectionHeader>Detalhes Energia</SectionHeader>
            ...
            {/* Additional services */}
            <SectionHeader>Servicos Adicionais</SectionHeader>
            ...
            {/* Payment section */}
            <SectionHeader>Pagamento</SectionHeader>
            ...
            {/* Commission */}
            <SectionHeader>Comissao</SectionHeader>
